...
<script>
    document.addEventListener("DOMContentLoaded", () => {
        ...
        async function fetchMovies(page = 1, genre = '', certification = '', adult = false, query = '') {
            //La variable du select
            const sort = document.getElementById('sort');
            //L'url pour modifier l'ordre 
            ...
            try {
                ...
                if (data.results && data.results.length > 0) {
                    data.results.forEach(movie => {
                        //L'url de l'image en fonction de si elle est dispo ou non
                        ...
                        // Changement de la source de limage par la variable imageURL
                        card.innerHTML = `
        ...
        //L'ecouteur d'evenement pour le trie
